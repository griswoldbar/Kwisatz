...
describe User do
  ...
  before(:each) do
    @attr = { :name => "John Blobson",
              :email => "blob@example.com",
              :password => "whibble",
              :password_confirmation => "whibble"
            }
    @user = User.new(@attr)
  end
  describe "validations" do
    ...
    it "should not allow lengthy names" do
      long_name="a"*51
    ...
    it "should accept valid email addresses" do
      addresses = %w[user@foo.com BASTARD@foo.bar.org first.last@foo.jp]
    ...
    it "should reject invalid email addresses" do
      addresses = %w[user@foo,com BASTARD_at_foo.bar.org first.last@foo.]
      addresses.each do |address|
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email address with no user" do
        User.authenticate("fuck@fuck.fuck", "@attr[:password]").should be_nil
      end
  ...
  describe "admin attribute" do
    ...
    it "should be convertibe to an admin" do
      @user.toggle!(:admin)
